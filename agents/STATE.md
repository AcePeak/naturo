...
>
> Last refreshed: 2026-07-27-1500 local+08 (Orc — **all 4 #1274 ENGINEERING blockers now addressed — #1306 (#1293) merged, and I landed the last one, #1175, as PR #1307 (`perf_counter` fix). #1274's flip is now NATUROBOT/Ace-gated only — no loop engineering left.**).
>
