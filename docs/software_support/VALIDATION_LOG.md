...
**Installed + evaluated this run: 21 apps (#12–31, #33; +#32 DB Browser installed
but its stale 2015 build crashes on launch — logged as a failure).** Wide tech coverage, mostly
