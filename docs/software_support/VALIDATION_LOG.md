...
**Installed + evaluated this run: 23 apps (#12–31, #33, #36–37; #34 Greenshot &
#35 HWiNFO64 PARTIAL; +#32 DB Browser installed but its stale 2015 build crashes
on launch — a failure).** #36 Notepad++ & #37 Calculator were evaluated from
already-present installs during a 电脑管家 download stall (see Open items). Wide tech coverage, mostly
