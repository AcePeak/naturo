...
**Installed + evaluated this run: 24 apps (#12–31, #33, #36–38; #34 Greenshot &
#35 HWiNFO64 PARTIAL; +#32 DB Browser installed but its stale 2015 build crashes
on launch — a failure).** #36–38 (Notepad++, Calculator, Task Manager) were evaluated
from already-present installs during a 电脑管家 download stall (see Open items). Wide tech coverage, mostly
